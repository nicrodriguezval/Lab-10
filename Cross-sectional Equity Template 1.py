...
def make_pipeline():
    ...
    equityPricing = SimpleMovingAverage(
        inputs=[EquityPricing.close],
        window_length=3,
        )
   
    long_term_debt_equity_ratio = SimpleMovingAverage(
    ...
    equityPricing_winsorized = equityPricing.winsorize(
        min_percentile=0.05,
        max_percentile=0.95
        )
   
    long_term_debt_equity_ratio_winsorized = long_term_debt_equity_ratio.winsorize(
       min_percentile=0.05,
       max_percentile=0.95    
        )
    ...
    combined_factor = (
        ...
        equityPricing_winsorized.zscore() +
        long_term_debt_equity_ratio_winsorized.zscore() +
